...
def ppo_loss(
    ...
    rng, key_action_logits = jax.random.split(rng)
    ...
    baseline = value_apply(value_params, jnp.concatenate([data.obs, data.goal], axis=-1))
    ...
    rewards = data.rewards * reward_scaling
    truncation = data.truncation
    termination = data.dones * (1 - truncation)
